...
//   }
//
//   UnauthorisedRequest unauthorisedRequest(String errorJson) {
//     return UnauthorisedRequest(
//       errorJson,
//     );
//   }
//
//   BadRequest badRequest(String errorJson) {
//     return BadRequest(
//       errorJson,
//     );
//   }
//
//   NotFound notFound(String errorJson) {
//     return NotFound(
//       errorJson,
//     );
//   }
...
//   }
//
//   InternalServerError internalServerError(String errorJson) {
...
//     @required Result unauthorisedRequest(String errorJson),
//     @required Result badRequest(String errorJson),
//     @required Result notFound(String errorJson),
...
//     @required Result internalServerError(String errorJson),
...
//     Result unauthorisedRequest(String errorJson),
//     Result badRequest(String errorJson),
//     Result notFound(String errorJson),
//     Result methodNotAllowed(),
//     Result notAcceptable(),
//     Result requestTimeout(),
//     Result sendTimeout(),
//     Result conflict(),
//     Result internalServerError(String errorJson),
...
//   @override
//   $Res call({
//     Object errorJson = freezed,
//   }) {
//     return _then(UnauthorisedRequest(
//       errorJson == freezed ? _value.errorJson : errorJson as String,
//     ));
//   }
// }
//
// class _$UnauthorisedRequest implements UnauthorisedRequest {
//   const _$UnauthorisedRequest(this.errorJson) : assert(errorJson != null);
//
//   @override
...
//   @override
//   String toString() {
//     return 'NetworkExceptions.unauthorisedRequest(errorJson: $errorJson)';
//   }
//
//   @override
//   bool operator ==(dynamic other) {
...
//             (identical(other.errorJson, errorJson) ||
//                 const DeepCollectionEquality()
//                     .equals(other.errorJson, errorJson)));
//   }
//
//   @override
//   int get hashCode =>
//       runtimeType.hashCode ^ const DeepCollectionEquality().hash(errorJson);
//
//   @override
...
//     assert(defaultError != null);
//     assert(unexpectedError != null);
//     return unauthorisedRequest(errorJson);
//   }
//
//   @override
//   @optionalTypeArgs
...
//   const factory UnauthorisedRequest(String errorJson) = _$UnauthorisedRequest;
//
//   String get errorJson;
//   $UnauthorisedRequestCopyWith<UnauthorisedRequest> get copyWith;
// }
//
...
//   const _$BadRequest(this.errorJson) : assert(errorJson != null);
//
//   @override
//   final String errorJson;
//
//   @override
//   String toString() {
//     return 'NetworkExceptions.badRequest(errorJson: $errorJson)';
//   }
//
//   @override
//   bool operator ==(dynamic other) {
...
//   const factory BadRequest(String errorJson) = _$BadRequest;
//
//   String get errorJson;
//   $BadRequestCopyWith<BadRequest> get copyWith;
// }
...
//   const _$NotFound(this.errorJson) : assert(errorJson != null);
//
//   @override
//   final String errorJson;
//
//   @override
//   String toString() {
//     return 'NetworkExceptions.notFound(errorJson: $errorJson)';
//   }
//
//   @override
//   bool operator ==(dynamic other) {
...
//   const factory NotFound(String errorJson) = _$NotFound;
//
//   String get errorJson;
//   $NotFoundCopyWith<NotFound> get copyWith;
// }
...
//   const _$InternalServerError(this.errorJson) : assert(errorJson != null);
//
//   @override
//   final String errorJson;
//
//   @override
//   String toString() {
//     return 'NetworkExceptions.internalServerError(errorJson: $errorJson)';
//   }
//
//   @override
//   bool operator ==(dynamic other) {
...
//   const factory InternalServerError(String errorJson) = _$InternalServerError;
//
//   String get errorJson;
//   $InternalServerErrorCopyWith<InternalServerError> get copyWith;
// }
